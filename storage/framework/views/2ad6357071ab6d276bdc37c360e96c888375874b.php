...
<section id="hero"><!---------------------**********  start video Slider ************--------------------------->
  ...
  <div class="bg_video"><!-- start video -->
    <video autoplay muted loop>
      <source src="<?php echo e(asset('sitecss/videos/bg_video.mp4')); ?>" type="video/mp4">
    </video><!-- End video -->
  </div>
      ...
      <div class="row" id="blood-type-wrapper"><!-- start profile of Donors users in blood filter --->
        ...
        <div class="col-lg-4 col-md-6 blood-type-item filter-O-Pos">
            <figure class="snip0016">
              <img src="<?php echo e(asset("storage/users/$user->img")); ?>" alt="sample41"/>
              <figcaption>
                <h4><b><?php echo e($user->name); ?></b></h4>
                <p>
                  From: <?php echo e($user->city); ?>

                  <br>
                  Blood Type: <?php echo e($user->blood_type); ?>
                ...
                <?php else: ?>
                <form action="/connect/<?php echo e(Auth::user()->id); ?>" method="post">
        ...
        <div class="col-lg-4 col-md-6 blood-type-item filter-A-Pos">
            <figure class="snip0016">
              ...
              <figcaption>
                ...
                <a href="/register"><button class="btn btn-sm"> Connect </button></a>
                <?php else: ?>
              <form action="/connect/<?php echo e(Auth::user()->id); ?>/<?php echo e($user->id); ?>" method="post">
                  <?php echo e(csrf_field()); ?>
  ...
  <section id="charities"><!--------------------******** start charities section ********---------------------------->
    ...
    <div class="container wow fadeIn">
      <div class="customer-logos slider">
        <div class="slide"><img src="<?php echo e(asset('sitecss/img/Charities/0120.png')); ?>"></div>
        <div class="slide"><img src="<?php echo e(asset('sitecss/img/Charities/referans-5.png')); ?>"></div>
        <div class="slide"><img src="<?php echo e(asset('sitecss/img/Charities/referans-4.png')); ?>"></div>
        <div class="slide"><img src="<?php echo e(asset('sitecss/img/Charities/referans-3.png')); ?>"></div>
        <div class="slide"><img src="<?php echo e(asset('sitecss/img/Charities/referans-2.png')); ?>"></div>
        <div class="slide"><img src="<?php echo e(asset('sitecss/img/Charities/0120.png')); ?>"></div>
        <div class="slide"><img src="<?php echo e(asset('sitecss/img/Charities/referans-5.png')); ?>"></div>
      </div>
    </div>
    ...
    <div class="container wow fadeInUp">
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6"><!--member one in the team --->
          <div class="member">
            <div class="pic">
              <img src="<?php echo e(asset('sitecss/img/avatar.png')); ?>" alt="">
            </div>
            <h4>Ahmed Alaa</h4>
        ...
        <div class="col-lg-3 col-md-6"><!--member two in the team --->
          <div class="member">
            <div class="pic"><img src="<?php echo e(asset('sitecss/img/avatar.png')); ?>" alt=""></div>
        ...
        <div class="col-lg-3 col-md-6"><!--member three in the team --->
          <div class="member">
            <div class="pic"><img src="<?php echo e(asset('sitecss/img/avatar.png')); ?>" class="img-fluid" alt=""></div>
            <h4>Momen Adel</h4>
            <div class="border"></div>
...
<?php echo $__env->make('userpages.master', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>